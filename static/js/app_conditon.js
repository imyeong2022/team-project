  ...
  $.ajax({
    ...
    success: function (data_list) {
      ...
      for (let i = 0; i < data_list.length; i++) {
        li +=
          '<li class="item"><div class = "box-text"><div class="box-btn-area"><a class="btn btn-default btn-md"><div><span>☆ 관심기업 등록하기</span></div></a><a class="btn btn-default btn-md"><div><span>일자리 지도 보기</span></div></a><!-- 1라인--><span class="grid-sub-blue">' +
